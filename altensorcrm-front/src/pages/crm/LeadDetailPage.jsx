...
import { leadsApi, orgsApi, contactsApi } from '../../services/api';
import {
  ChevronDownIcon,
  ChevronUpIcon,
  XMarkIcon,
...
const LeadDetailPage = () => {
  ...
  return (
    <div className="-m-4 lg:-m-6 -mb-20 min-h-screen bg-[#121214] text-[#E4E4E7] flex flex-col font-sans relative">
      ...
      <div className="px-6 border-b border-[#2C2C2E]/60 bg-[#121214] flex items-center gap-6 text-xs text-[#A1A1AA] overflow-x-auto custom-scrollbar shrink-0">
        {['Activity', 'Emails', 'Comments', 'Data', 'Calls', 'Tasks', 'Notes', 'Attachments'].map((tab) => (
          <button
            ...
            className={`py-3 font-medium transition-colors border-b-2 cursor-pointer flex items-center gap-1.5 ${activeTab === tab
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-w-0">
        ...
        <div className="flex-1 p-6 lg:p-8 overflow-y-auto custom-scrollbar flex flex-col justify-between space-y-6">
          <div className="space-y-6 flex-1">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-[#A1A1AA]">created this lead</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-semibold text-white">Administrator</span>
                        <span className="text-[#A1A1AA]">added a <strong className="text-white">comment</strong></span>
                      </div>
            ...
            {/* 2. EMAILS TAB (Screenshot 2 Match!) */}
            {activeTab === 'Emails' && (
              <>
                <div className="flex items-center justify-between border-b border-[#2C2C2E]/40 pb-3.5">
            ...
            {/* 3. COMMENTS TAB (Screenshot 3 Match!) */}
            {activeTab === 'Comments' && (
              <>
                <div className="flex items-center justify-between border-b border-[#2C2C2E]/40 pb-3.5">
                  ...
                  {isDetailsOpen && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 text-xs">
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Industry</label>
                          <select
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Lead Owner</label>
                          <select
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Job Title</label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Source</label>
                          <select
                  ...
                  {isPersonOpen && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 text-xs">
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Email</label>
                          <input
                            type="email"
                      ...
                      <div className="space-y-3.5">
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">First Name <span className="text-rose-400">*</span></label>
                          <input
                            type="text"
                            required
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[#A1A1AA] font-medium">Mobile No.</label>
                          <input
                            type="text"
            ...
            {/* 5. CALLS TAB (Screenshot 4 Match!) */}
            {activeTab === 'Calls' && (
              <>
                <div className="flex items-center justify-between border-b border-[#2C2C2E]/40 pb-3.5">
            ...
            {/* 7. NOTES TAB (Screenshot 5 Match!) */}
            {activeTab === 'Notes' && (
              <>
                <div className="flex items-center justify-between border-b border-[#2C2C2E]/40 pb-3.5">
            ...
            {activeTab === 'Attachments' && (
              <>
                ...
                <div className="py-16 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-xs text-[#A1A1AA] max-w-sm mt-1">
                    No attachments found for this lead. Upload files to keep track.
                  </p>
                </div>
              </>
            )}
          ...
          {/* Bottom Fixed Action Bar (Screenshots 1, 2, 3, 4, 5 Match!) */}
        ...
        <div className="w-full lg:w-80 shrink-0 border-l border-[#2C2C2E]/60 bg-[#121214] p-5 space-y-5 text-xs overflow-y-auto custom-scrollbar">
          ...
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-sm font-bold text-white leading-tight truncate">{fullName || 'Lead Details'}</h2>
          </div>
          ...
          <div className="space-y-3">
            ...
            {isSidebarDetailsOpen && (
              <div className="space-y-3 text-[#D4D4D8]">
                <div>
                  <span className="text-[#71717A] block text-[11px]">Organization</span>
                ...
                <div>
                  <span className="text-[#71717A] block text-[11px]">Industry</span>
                  <span className="font-semibold text-white">{formData.industry || '—'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Job Title</span>
                  <span className="text-[#71717A]">{formData.jobTitle || 'Add Job Title...'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Source</span>
                  <span className="text-[#71717A]">{formData.source || 'Add Source...'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Lead Owner</span>
          ...
          <div className="space-y-3">
            ...
            {isSidebarPersonOpen && (
              <div className="space-y-3 text-[#D4D4D8]">
                <div>
                  <span className="text-[#71717A] block text-[11px]">Salutation</span>
                  <span className="font-semibold text-white">{formData.salutation || '—'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">First Name *</span>
                  <span className="font-semibold text-white">{formData.firstName || '—'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Last Name</span>
                  <span className="font-semibold text-white">{formData.lastName || '—'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Email</span>
                  <span className="text-white truncate block">{formData.email || '—'}</span>
                </div>

                <div>
                  <span className="text-[#71717A] block text-[11px]">Mobile No.</span>
      ...
      {/* CONVERT TO DEAL MODAL (Screenshots 1, 2, 3 Match!) */}
      {isConvertModalOpen && (
        <div className="fixed inset-0 z-[120] bg-black/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-3xl shadow-2xl p-6 w-full max-w-lg text-[#E4E4E7] space-y-5 animate-in fade-in duration-200" ref={convertModalRef}>
            ...
            <div className="flex items-center justify-between border-b border-[#2C2C2E]/60 pb-3">
              <h2 className="text-lg font-bold text-white tracking-tight">Convert to Deal</h2>
            ...
            <div className="space-y-5 text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-medium text-white">Choose Existing</span>
                  <button
                    type="button"
              ...
              {/* 3. STATUS SECTION (Exact Screenshot Match!) */}

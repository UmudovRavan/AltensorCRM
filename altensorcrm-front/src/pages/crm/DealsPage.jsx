      ...
      <div className="flex flex-wrap lg:flex-nowrap items-center justify-between gap-2.5 relative z-20">
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative" ref={orgRef}>
            ...
            >
              <span className="truncate">{selectedOrgFilter}</span>
        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-3xl shadow-2xl p-6 w-full max-w-2xl text-[#E4E4E7] space-y-5 animate-in fade-in duration-200 overflow-visible" ref={createDropdownRef}>
            ...
            <div className="flex items-center justify-between border-b border-[#2C2C2E]/60 pb-3">
              <h2 className="text-lg font-bold text-white tracking-tight">Create Deal</h2>
            ...
            <div className="flex flex-wrap items-center gap-6 text-xs text-[#A1A1AA] pb-1">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <button
                  ...
                  className={`w-9 h-5 rounded-full p-0.5 transition-colors cursor-pointer flex items-center ${chooseExistingOrg ? 'bg-white justify-end' : 'bg-[#3F3F46] justify-start'
                    }`}
                >
              ...
              <div className="flex items-center gap-2.5">
                <span>Choose Existing Contact</span>
                <button
                  type="button"
                  onClick={() => setChooseExistingContact(!chooseExistingContact)}
                  className={`w-9 h-5 rounded-full p-0.5 transition-colors cursor-pointer flex items-center ${chooseExistingContact ? 'bg-white justify-end' : 'bg-[#3F3F46] justify-start'
                    }`}
                >
                  <span className={`w-4 h-4 rounded-full shadow-md ${chooseExistingContact ? 'bg-black' : 'bg-[#A1A1AA]'}`}></span>
                </button>
              </div>
            </div>
            ...
            <form onSubmit={handleFullCreateDealSubmit} className="space-y-4 text-xs">
              ...
              {chooseExistingContact ? (
                ...
                <div className="space-y-1.5 relative">
                  <label className="text-[#A1A1AA] font-medium">Contact</label>
                  <button
                    type="button"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="space-y-1.5 relative">
                      ...
                      <button
                        ...
                        className="flex items-center justify-between w-full bg-[#141416] border border-[#2C2C2E] rounded-xl px-3 py-2 text-xs text-[#D4D4D8] hover:border-sky-500 transition-colors cursor-pointer"
                      >
                        <span className="truncate">{dealForm.salutation}</span>
                        <ChevronDownIcon className="w-3.5 h-3.5 text-[#71717A] shrink-0" />
                      </button>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div className="space-y-1.5 relative">
                      ...
                      <button
                        ...
                        className="flex items-center justify-between w-full bg-[#141416] border border-[#2C2C2E] rounded-xl px-3 py-2 text-xs text-[#D4D4D8] hover:border-sky-500 transition-colors cursor-pointer"
                      >
                        <span className="truncate">{dealForm.gender}</span>
                        <ChevronDownIcon className="w-3.5 h-3.5 text-[#71717A] shrink-0" />
                      </button>
                ...
                <div className="space-y-1.5 relative">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      ></span>
                      <span className="font-semibold">{dealForm.status}</span>
                    </div>
                    <ChevronDownIcon className="w-3.5 h-3.5 text-[#71717A] shrink-0" />
                  </button>

...
const ContactDetailPage = () => {
  ...
  const contactTitle = `${formData.salutation ? `${formData.salutation} ` : ''}${formData.firstName} ${formData.lastName}`.trim() || 'Contact Details';
    ...
    <div className="-m-4 lg:-m-6 -mb-20 min-h-screen bg-[#121214] text-[#E4E4E7] flex flex-col font-sans relative">
      ...
      <div className="px-6 py-3 border-b border-[#2C2C2E]/60 bg-[#121214] flex items-center justify-between shrink-0">
        <div className="flex items-center gap-2 text-xs font-medium text-[#A1A1AA]">
          <Link to="/crm/contacts" className="hover:text-white transition-colors">Contacts</Link>
          <span>/</span>
          <Link to="/crm/contacts" className="hover:text-white transition-colors">List</Link>
          <span>/</span>
          <span className="text-white font-semibold">{contactTitle.toLowerCase()}</span>
        </div>
      </div>

      {/* 2. MAIN TWO-COLUMN CONTENT BODY (Screenshot 1 Match!) */}
      <div className="flex-1 flex flex-col lg:flex-row min-w-0">
        ...
        <div className="w-full lg:w-80 shrink-0 border-r border-[#2C2C2E]/60 bg-[#121214] p-6 space-y-6 text-xs overflow-y-auto custom-scrollbar">
          ...
          {/* Details Section (Screenshot 1 Match!) */}
            ...
            {isDetailsOpen && (
              <div className="space-y-3.5 text-xs">
                ...
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Salutation</label>
                  <select
                  ...
                  >
                    {salutationOptions.map(s => <option key={s} value={s} className="bg-[#1C1C1E]">{s}</option>)}
                  </select>
                </div>

                {/* First Name */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">First Name</label>
                  <input
                    type="text"
                ...
                {/* Last Name */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Last Name</label>
                  <input
                    type="text"
                ...
                {/* Email Address */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Email Address</label>
                  <input
                    type="email"
                ...
                {/* Mobile Number */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Mobile Number</label>
                  <input
                    type="text"
                ...
                {/* Gender */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Gender</label>
                  <select
                    ...
                    className="w-full bg-transparent border-none text-white focus:outline-none focus:ring-1 focus:ring-sky-500 rounded px-1 py-1 cursor-pointer"
                  >
                    {genderOptions.map(g => <option key={g} value={g} className="bg-[#1C1C1E]">{g}</option>)}
                  </select>
                </div>

                {/* Organization */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Organization</label>
                  <input
                    type="text"
                ...
                {/* Designation */}
                <div className="space-y-1">
                  <label className="text-[#71717A] text-[11px] block">Designation</label>
                  <input
                    type="text"
        ...
        {/* RIGHT MAIN PANEL: DEALS TABLE (Screenshot 1 & 2 Match!) */}
                  ...
                  associatedDeals.map((deal) => {
                    ...
                    return (
                      <tr key={deal.id} className="border-b border-[#2C2C2E]/40 hover:bg-[#1C1C1E]/60 transition-colors">
                        {/* Organization (Clickable Link to Deal's Data tab!) */}
